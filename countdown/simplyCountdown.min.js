...
function _typeof(t){
    return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){
        return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}!function(t){
            var n=function t(n)
            {for(var e,o=n||{},s=1;s<arguments.length;s+=1)
                {e=arguments[s];var r=Object.keys(e);
                    if(r.length)
                            ...
                            t.simplyCountdown=function(t,o){
                                ...
                                w=n({
                                    ...
                                    words:{
                                        ...
                                        :a;var f,
                                        h=function(t){
                                            var n,o=t,a=function(t,n){var o;
                                                return t.inline?
                                                ...
                                                (n=function(){
                                                    var t,n,e,y,g=function(){
                                                        ...
                                                        u%=86400,d=parseInt(u/3600,10),
                                                        u%=3600,p=parseInt(u/60,10),m=parseInt(u%60,10)};
                                                        l=new Date,w.enableUtc?(i=new Date(l.getFullYear(),
                                                        l.getMonth(),
                                                        l.getDate(),
                                                        l.getHours(),
                                                        l.getMinutes(),
                                                        l.getSeconds()),
                                                        u=(r-i.getTime())/1e3):
                                                        u=(r-l.getTime())/1e3,u>0?g():
                                                        w.countUp?(u=(l.getTime()-r)/1e3,g()):(
                                                            c=0,d=0,p=0,m=0,window.clearInterval(s),
                                                            w.onEnd()),
                                                            w.plural?
                                                            (t=c>1?w.words.days.plural:w.words.days.singular,
                                                                ...
                                                                (t=w.words.days.singular,n=w.words.hours.singular,
                                                                    e=w.words.minutes.singular,y=w.words.seconds.singular),
                                                                    w.inline?o.innerHTML="".concat(c," ")
                                                                    .concat(t,", ")+""
                                                                    .concat(d," ")
                                                                    .concat(n,", ")+""
                                                                    .concat(p," ")
